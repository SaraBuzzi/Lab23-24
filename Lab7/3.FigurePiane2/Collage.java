...
public class Collage {
    ...
    public void ordinaPerArea() {
        //MODIFIES: this
        //EFFECTS: ordina gli elementi in this in base alla loro area
    ...
    public double areaTot() {
        //EFFECTS: restituisce l'area totale delle figure presenti in this
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Area totale: " + figure.areaTot());

        System.out.println("Ordinati per area: ");
        figure.ordinaPerArea();
